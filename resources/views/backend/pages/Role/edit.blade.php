        ...
        <div class="container-fluid">
            <div class="row" style="color: #444;">
                <div class="col-xl-10 col-lg-9 col-md-9 ml-auto">
                        ...
                        <div class="col">
                            <div class="row shadow-sm text-muted">
                                ...
                                <div class="ml-auto mr-3">
                                    <a href="{{ route('role.update', $role->id) }}" class="btn btn-sm btn-info px-3 rounded-0">Role
                                        List</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <!--Input Group Start-->
                    <form class="py-4" method="POST" action="{{ route('role.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="form-row">
                            <div class="col-sm-5" style="order-right: 1px solid black;">
                                ...
                                <div class="form-group row">
                                    <label for="EmployeLabel"
                                        class="col-sm-4 col-form-label col-form-label-sm"><strong>Role Name :
                                        </strong></label>
                                    <div class="col-sm-8">
                                        <input type="text" name="name" value="{{ $role->name }}" id="name"
                                            ...
                                            placeholder="Role here..." required>
                                    </div>
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    <label for="EmployeID"
                                        class="col-sm-4 col-form-label col-form-label-sm text-md-right"><strong>Role Slug
                                            :
                                        </strong></label>
                                    <div class="col-sm-8">
                                        <input type="text" name="slug" id="emp_id" value="{{ $role->slug }}"
                                            class="form-control form-control-sm form_check_color_right"
                                            placeholder="Slug Here" required>
                                    </div>
                                    @if ($errors->has('slug'))
