                    ...
                    <div class="col">
                        <div class="row ">
                            <div class="col text-uppercase">
                                <h4> <strong > Role List</strong>  </h4>
                            </div>
                            <!-- Button Add Brand modal -->
                            <div class="ml-auto mr-3">
                                <a href="{{ route('role.create') }}" class="btn btn-sm btn-info px-3 rounded-0">Add Role</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group btn-block" role="group" aria-label="Basic example">
                                        {{-- <a href="{{ route('role.show', $role->id) }}" type="button" class="btn btn-sm  btn-primary">View</a> --}}
                                        <a href="{{ route('role.edit', $role->id) }}" type="button" class="btn btn-sm btn-info">Edit</a>
