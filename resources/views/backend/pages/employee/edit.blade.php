                        ...
                        <div class="form-row">
                            <div class="col-sm-5" style="order-right: 1px solid black;">
                                ...
                                {{-- <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="password" name="password_confirmation" id="password_confirmation" value="{{ $employee->password }}"
                                ...
                                <div class="form-group row">
                                    <label for="colFormLabel"
                                        class="col-sm-4 col-form-label col-form-label-sm text-md-right"><strong>
                                            ...
                                            : </strong></label>
                                    <div class="col-sm-8">
                                        <input type="date" name="date_of_joining" value="{{ $employee->date_of_joining }}" max="3000-12-31" min="1000-01-01"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="status" name="status" value="{{ old('status') }}" class="custom-select border-0">
                                                <option class="text-success" {{ $employee->status=== 1 ? 'selected':'' }} value="1">Active
                                                </option>
                                                <option class="text-danger" {{ $employee->status=== 0 ? 'selected':'' }}  value="0">Deactive
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="input-group">
                                        <div class="col text-center">
                                            ...
                                            <img  id="thumbnil" src="{{ asset($employee->image) }}"  width="170" class="img-fluid m-2">
