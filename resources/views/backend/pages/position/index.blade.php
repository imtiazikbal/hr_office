...
@section('content')
                        ...
                        <div class="col">
                            <div class="row ">
                                <div class="col text-uppercase">
                                    <h4> <strong> Position List</strong> </h4>
                                </div>
                                <!-- Button Add Brand modal -->
                                <div class="ml-auto mr-3">
                                    <button data-toggle="modal" data-target="#exampleModal"
                                        class="btn btn-sm btn-info px-3 rounded-0">Add Position</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="col-sm-12" style="order-right: 1px solid black; margin-top: 50px;">
                                                ...
                                                <div class="form-group row">
                                                    <label for="EmployeLabel"
                                                        class="col-sm-4 col-form-label "><strong>Position Name
                                                        </strong></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="empName" id="name"
                                                            id="EmployeLabel" class="form-control form_check_color_right"
                                                            placeholder="Position Name here..." required>
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label for="EmployeLabel"
                                                        class="col-sm-4 col-form-label "><strong>Position Des
                                                        </strong></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="empName" id="des"
                                                            id="EmployeLabel" class="form-control form_check_color_right"
                                                            placeholder="Position description here..." required>
                                                    </div>
                                                </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add Possition</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                        ...
                                        <form method="POST" class="was-validated" id="edit-form">
                                            <div class="row p-sm-4">
                                                <div class="col-sm-12" style="order-right: 1px solid black; margin-top: 50px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="EmployeLabel"
                                                            class="col-sm-4 col-form-label "><strong>Possition Name
                                                            </strong></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="empName" id="posName"
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="EmployeLabel"
                                                            class="col-sm-4 col-form-label "><strong>Possition Des
                                                            </strong></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" id="posDes"
                                                               class="form-control form_check_color_right"
    ...
    axios.get('/position/edit/' + id)
        .then(function(response) {
            let itemData = response.data;
      
           document.getElementById('updateID').value=id;

            $('#editModal #posName').val(itemData.name);
            $('#editModal #posDes').val(itemData.des);
...
async function UpdateData() {
    let position = document.getElementById('updateID').value; 

    let name = document.getElementById('posName').value;
    let des = document.getElementById('posDes').value;
    ...
    if (name.length === 0 ) {
        ...
        try {
            ...
            let response = await axios.post('position/update/' + position, forData);
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            // loader show
            showLoader();
            axios.delete('/position/delete/' + id)
                .then(function(response) {
...
async function saveData() {
    ...
    if (name.length === 0 || des.length === 0) {
        ...
        try {
            showLoader();
            let response = await axios.post('position/store', forData);
            hideLoader();
